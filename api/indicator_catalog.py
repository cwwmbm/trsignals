...
INDICATOR_CATALOG: list[IndicatorDef] = [
    ...
    _entry(
        ...
        "pattern",
        "flag",
        description="Flag (1) on calendar Mondays when Monday close is below the prior Friday close; a Tuesday that is the first trading day of the week does not count; otherwise −1.",
    ),
