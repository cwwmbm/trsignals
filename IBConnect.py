...
def main():
    ...
    data = dt.get_data_yf(yfticker, 15, False) #True for local data, False for Yahoo Finance
    ...
    #data['Buy'] = data['Buy'] & (data['IBR'] < 0.2)
    ...
    #results = bt.backtest_days(data, 20, is_long)
