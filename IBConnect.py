...
def indicator_tryout(data, days, profit, is_long, is_sell = False, og = False):
    running_results = pd.DataFrame(columns=['Indicator', 'Condition', 'Value', 'PnL', 'MaxDD', 'Trades', '%Pstv', 'CAGR','Sharpe', 'Sortino'])

    results = bt.backtest_ind(data, days, profit, is_long, 'VFI80', 'both', -15, 15, 2, og) if not is_sell else bt.backtest_sell_ind(data, days, profit, is_long, 'VFI80', 'both', -15, 15, 2, og)
    running_results = running_results._append(results.head(3))
    print (results.head(5))
    results = bt.backtest_ind(data, days, profit, is_long, 'VFI40', 'both', -15, 15, 2, og) if not is_sell else bt.backtest_sell_ind(data, days, profit, is_long, 'VFI40', 'both', -15, 15, 2, og)
    running_results = running_results._append(results.head(3))
    print (results.head(5))
    results = bt.backtest_ind(data, days, profit, is_long, 'VFI10', 'both', -15, 15, 2, og) if not is_sell else bt.backtest_sell_ind(data, days, profit, is_long, 'VFI10', 'both', -15, 15, 2, og)
    running_results = running_results._append(results.head(3))
    print (results.head(5))
    results = bt.backtest_ind(data, days, profit, is_long, 'VFI20', 'both', -15, 15, 2, og) if not is_sell else bt.backtest_sell_ind(data, days, profit, is_long, 'VFI20', 'both', -15, 15, 2, og)
    print (results.head(5))
    running_results = running_results._append(results.head(3))
    ...
    results = bt.backtest_ind(data, days, profit, is_long, 'RSI14Breadth', 'both', 10, 90, 10, og) if not is_sell else bt.backtest_sell_ind(data, days, profit, is_long, 'RSI14Breadth', 'both', 10, 90, 10, og)
    print (results.head(5))
    running_results = running_results._append(results.head(3))
    ...
    print (results.head(5))
    running_results = running_results._append(results.head(3))
    results = bt.backtest_ind(data, days, profit, is_long, 'RSI5Breadth', 'both', 10, 90, 10, og) if not is_sell else bt.backtest_sell_ind(data, days, profit, is_long, 'RSI5Breadth', 'both', 10, 90, 10, og)
    print (results.head(5))
    running_results = running_results._append(results.head(3))
    results = bt.backtest_ind(data, days, profit, is_long, 'RSI14RiskBreadth', 'both', 10, 90, 10, og) if not is_sell else bt.backtest_sell_ind(data, days, profit, is_long, 'RSI14RiskBreadth', 'both', 10, 90, 10, og)
    print (results.head(5))
    running_results = running_results._append(results.head(3))
    results = bt.backtest_ind(data, days, profit, is_long, 'RSI5RiskBreadth', 'both', 10, 90, 10, og) if not is_sell else bt.backtest_sell_ind(data, days, profit, is_long, 'RSI5RiskBreadth', 'both', 10, 90, 10, og)
    print (results.head(5))
    running_results = running_results._append(results.head(3))
    ...
    print (results.head(5))
    running_results = running_results._append(results.head(3))
    results = bt.backtest_ind(data, days, profit, is_long, 'RSI5SemisBreadth', 'both', 10, 90, 10, og) if not is_sell else bt.backtest_sell_ind(data, days, profit, is_long, 'RSI5SemisBreadth', 'both', 10, 90, 10, og)
    print (results.head(5))
    running_results = running_results._append(results.head(3))
    results = bt.backtest_ind(data, days, profit, is_long, 'RSI14SemisBreadth', 'both', 10, 90, 10, og) if not is_sell else bt.backtest_sell_ind(data, days, profit, is_long, 'RSI14SemisBreadth', 'both', 10, 90, 10, og)
    print (results.head(5))
    running_results = running_results._append(results.head(3))
...
def main():
    ...
    #data['Buy'], days, profit, description, verdict, is_long, ignore = ind.buy_signal10(data)
    data['Buy'], days, profit, description, verdict, is_long, ignore = ind.og_new_buy_signal(data)
    #data['Buy'] = data['Buy'] & (data['RSI14SemisBreadth'] > 30)
    ...
    #indicator_tryout(data, days, profit, is_long, is_sell = False, og = True)
    #indicator_tryout(data, days, profit, is_long, is_sell = True, og = True)
    #results = bt.backtest_ind(data, days, profit, is_long, 'RSI5Breadth', 'both', 10, 90, 10, og = True)
    #print (results)
